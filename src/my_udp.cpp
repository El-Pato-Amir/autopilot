...
MyUdp::MyUdp(std::string const& a_address, uint32_t const& a_port, uint32_t const& a_time_out)
: m_socket(-1)
...
ssize_t MyUdp::send(std::string const& a_msg)
{
...
void MyUdp::set_timeout(uint32_t const& a_time)
{
    m_timeout = a_time;
